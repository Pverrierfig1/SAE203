    ...
    <div class="card shadow mb-4 border-primary">
        <div class="card-body bg-light">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">Liste des pages : </li>
                <ul>
                    ...
                    <li><code>Déconnexion</code> : page de déconnexoin des utilisateurs, <em>deconnexion.php</em></li>
                    ...
                    <ul>
                        ...
                        <li><code>Modification</code> : zone de dépot des fichiers à partager, <em>depot.php</em></li>
                    </ul>
        ...
        <div class="card-body bg-light">
            ...
            <ul class="list-group list-group-flush">
                ...
                <ul>
                    ...
                    <li><code>Modifier</code> : les informations concernant un fournisseurs</li>
                    <li><code>Supprimer</code> : un fournisseurs</li>
                </ul>
            </ul>
        </div>
    </div>
